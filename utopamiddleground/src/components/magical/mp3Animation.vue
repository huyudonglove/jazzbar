  ...
  <div>
      <div>
       <div class="layoutD">
          ...
          <div class="rightD">
              ...
              <el-tab-pane label="组件" v-if="appPower.length" name="first">
                ...
                <el-button style="width:100px;" :disabled="isLook||!appPower[0].isCheck" type="primary" @click="addNode({step:1,text:'MP3动画',type:'MP3动画',data:nodeData1,isLastNode:false,icon:''})">MP3动画</el-button>
       ...
       MP3动画管理
        ...
        <mp3AnimationTable type="list" @editOrLook="edit" ref="mp3AnimationTable"></mp3AnimationTable>
    </div>
    <div v-if="showPlay">
