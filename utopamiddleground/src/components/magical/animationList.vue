      ...
      <div v-if="type=='list'">
        <div style="background:#f0f0f5;margin-top:10px">
          <el-row class="tac" style="border-bottom:1px solid #eeeeee; padding:15px 0">
            ...
            <!-- <span>
              <commonDel :id='selectId' :all="true"></commonDel>
            </span> -->
          </el-row>
        </div>
        <div>
          <el-table :data="tableData" stripe style="width: 100%" @selection-change="handleSelectionChange" border  ref="listTable" row-key="id" :max-height="tableHeight" :cell-class-name="offLine">
            ...
            <el-table-column prop="address" width="210" label="操作" fixed="right" align="center">
              <template slot-scope="scope">
                <!-- <el-button type="primary" size="mini" @click="editOrLook(scope.row,false)">编辑</el-button> -->
                 <el-button size="mini"  @click="editOrLook(scope.row,true)" type="warning">查看</el-button>
