        ...
        <div class="rightD">
          <el-tabs type="border-card" v-model="activeName">
            ...
            <el-tab-pane label="组件"  name="first">
              ...
              <el-button type="primary" @click="nodeMsg.text='钢琴';nodeMsg.type='piano';nodeMsg.data=nodeData1;addNode(nodeMsg)" :disabled="true">钢琴</el-button>
            </el-tab-pane>
