          ...
          <div class="rightD">
            <el-tabs type="border-card" v-model="activeName">
              ...
              <el-tab-pane label="组件"   name="first">
                ...
                <el-button style="width:100px;" type="primary" :disabled="true" @click="addNode({step:1,text:'MP4视频',type:'mp4',data:nodeData1,isLastNode:false,icon:'gif'})">MP4视频</el-button>
                <p class="font20">素材节点</p>
                <el-button style="width:100px;" type="primary" :disabled="true" @click="addNode({step:2,text:'视频',type:'video',data:nodeData2,isLastNode:true,icon:'video'})">视频</el-button>
              </el-tab-pane>
...
import mp4videoTable from './mp4videoTable';
