       ...
       <div style="background:#f0f0f5;margin-top:10px">
        ...
        <div>
          <el-table :data="tableData" stripe style="width: 100%" @selection-change="handleSelectionChange" border  ref="listTable" row-key="id" :max-height="tableHeight" :cell-class-name="offLine">
            ...
            <el-table-column prop="name" label="模型名称" width="" align="center"></el-table-column>
            <el-table-column prop="pic" label="封面图" width="150" align="center">
                <template slot-scope="scope">
                <span style="cursor: pointer;" >
                 <img :src="scope.row.pic?`/static/${scope.row.pic}`:''" alt=""  style="width:50px;height:50px" v-focus>
                </span>
              </template>
            </el-table-column>
            <el-table-column prop="commonModelName" label="普通模型" width="150" align="center">
              <template slot-scope="scope">
            ...
            <el-table-column prop="mp4ModelName" label="MP4模型" width="120" align="center">
              <template slot-scope="scope">
                <span>{{scope.row.modelCount}}</span>
                <img src="../../assets/warn.png" alt="" v-if="scope.row.modelCount&&(scope.row.materialDelState==1||scope.row.materialIsValidState==1||scope.row.materialState==2)">
              </template>
            </el-table-column>
