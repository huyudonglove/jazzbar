          ...
          <div class="rightD">
            <el-tabs type="border-card" v-model="activeName">
              ...
              <el-tab-pane label="组件"  name="first">
                ...
                <el-button style="width:100px;" type="primary" :disabled="true" @click="addNode({step:1,text:'载体模型',type:'载体',data:nodeData1,icon:'img'})">载体模型</el-button>
                <p class="font20">素材节点</p>
                <div style="margin-bottom:20px;">
                  <el-button style="width:100px;" type="primary" :disabled="true" @click="addNode({step:2,text:'Android',type:'android',data:nodeData2,isLastNode:true,icon:''})">Android</el-button>
                  <el-button style="width:100px;" type="primary" :disabled="true" @click="addNode({step:2,text:'IOS',type:'IOS',data:nodeData2,isLastNode:true,icon:''})">IOS</el-button>
                </div>
                <div>
                  <el-button style="width:100px;" type="primary" :disabled="true" @click="addNode({step:2,text:'UWP',type:'UWP',data:nodeData2,isLastNode:true,icon:''})">UWP</el-button>
                  <el-button style="width:100px;" type="primary" :disabled="true" @click="addNode({step:2,text:'Windows',type:'Windows',data:nodeData2,isLastNode:true,icon:''})">Windows</el-button>
                </div>
              </el-tab-pane>
...
import carrierModelTable from './carrierModelTable';
