      ...
      <div v-if="type=='list'&&appPower.length">
        ...
        <div>
          <el-table :data="tableData" stripe style="width: 100%" @selection-change="handleSelectionChange" border  ref="listTable" :max-height="tableHeight" row-key="id" :cell-class-name="offLine">
            ...
            <el-table-column prop="name" label="场次名称" width="180" align="center"></el-table-column>
            <el-table-column prop="sceneCount" label="场景数量" width="120" align="center">
              <template slot-scope="scope">
                <span>{{scope.row.sceneCount}}</span>
                <img src="../../assets/warn.png" alt="" v-if="!scope.row.sceneIsValid">
              </template>
            </el-table-column>
            <el-table-column prop="programCount" label="节目数量" width="120" align="center">
              <template slot-scope="scope">
                <span>{{scope.row.programCount}}</span>
                <img src="../../assets/warn.png" alt="" v-if="!scope.row.programIsValid">
              </template>
            </el-table-column>
            <el-table-column prop="startTime" label="播放时间" width="180" align="center">
              <template slot-scope="scope">
      ...
      <div v-if="type=='box'">
        ...
        <div style="position:relative;">
          ...
          <el-table :data="tableData" stripe style="width: 100%" @selection-change="handleSelectionChange" border  ref="boxTable" row-key="id" :cell-class-name="offLine">
            ...
            <el-table-column prop="num" label="场景数量"></el-table-column>
          </el-table>
        </div>
        <div>
