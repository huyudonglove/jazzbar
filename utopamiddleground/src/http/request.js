...
/** 组类连接-获取列表 Author:minggui*/
export function getGroupList(params){
  return new Promise((resolve,reject)=>{
    http.post('/api/utopa/ar/material/group/page',params).then(res=>{
      if(res.code){
        Message.error(res.msg)
      }else{
        resolve(res);
...
/** 组类连接-获取组类详情 Author:minggui*/
export function getGroupInfo(params){
  return new Promise((resolve,reject)=>{
    http.get('/api/utopa/ar/material/group/info',params).then(res=>{
      if(res.code){
        Message.error(res.msg)
      }else{
        resolve(res);
...
/** 组类连接-批量添加 Author:minggui*/
export function batchAddGroup(params){
  return new Promise((resolve,reject)=>{
    http.post('/api/utopa/ar/material/group/batchAdd',params).then(res=>{
      if(res.code){
        Message.error(res.msg)
      }else{
        resolve(res);
...
/** 组类连接-编辑 Author:minggui*/
export function editGroup(params){
  return new Promise((resolve,reject)=>{
    http.post('/api/utopa/ar/material/group/update',params).then(res=>{
      if(res.code){
        Message.error(res.msg)
      }else{
        resolve(res);
...
/** 查询指定的素材 Author:minggui*/
export function queryMaterialById(params) {
  return new Promise((resolve,reject)=>{
    http.get('/api/utopa/ar/material/queryMaterialById',params).then(res=>{
      if(res.code){
        Message.error(res.msg);
      }else{
        resolve(res);
...
/** 查询指定的素材分类id组 Author:minggui*/
export function queryMaterialCategoryById(params) {
  return new Promise((resolve,reject)=>{
    http.get('/api/utopa/ar/material/category/queryMaterialCategoryById',params).then(res=>{
      if(res.code){
        Message.error(res.msg);
      }else{
        resolve(res);
...
/*获取u3d信息*/
export function getU3d(id){
  return http.get('/api/utopa/ar/material/config/list',{type:id})
}
/** 魔幻演奏-设备投放列表 Author:minggui*/
export function getEquipPutList(params){
  return new Promise((resolve,reject)=>{
    http.post('/api/utopa/ar/device/putIn/page',params).then(res=>{
      if(res.code){
        Message.error(res.msg)
      }else{
        resolve(res);
...
/** 魔幻演奏-设备投放详情 Author:minggui*/
export function getEquipPutInfo(params){
  return new Promise((resolve,reject)=>{
    http.get('/api/utopa/ar/device/putIn/info',params).then(res=>{
      if(res.code){
        Message.error(res.msg)
      }else{
        resolve(res);
...
/*魔幻演奏-编辑设备投放 Author:minggui*/
export function editEquipPut(msg){
  return http.post('/api/utopa/ar/device/putIn/update',msg)
}
/*魔幻演奏-批量添加设备投放 Author:minggui*/
export function batchAddEquipPut(msg){
  return http.post('/api/utopa/ar/device/putIn/batchAdd',msg)
}
/** 魔幻演奏-设备投放上下架 Author:minggui*/
export function setEquipPutStatus(params){
  if(params.state==1){
    return http.get('/api/utopa/ar/device/putIn/upper',{id:params.id})
  }else{
    return http.get('/api/utopa/ar/device/putIn/lower',{id:params.id})
  }
...
/*编辑素材 Author:minggui*/
export function editMaterial(msg){
  return new Promise((resolve,reject)=>{
    http.post('/api/utopa/ar/material/edit',msg).then(res=>{
      if(res.code){
        Message.error(res.msg);
      }else{
        resolve(res);
...
/*批量新增素材 Author:minggui*/
export function batchAddMaterial(msg){
  return new Promise((resolve,reject)=>{
    http.post('/api/utopa/ar/material/batchAdd',msg).then(res=>{
      if(res.code){
        Message.error(res.msg);
      }else{
        resolve(res);
...
export function removeMaterial(params) {
  return loadRequest('/api/utopa/ar/background/app/removeMaterial', params, '清除', http, 'post')
}
/** app应用管理-用户选择位置列表 w*/
