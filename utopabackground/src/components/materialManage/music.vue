       ...
       <div class="layoutD">
          ...
          <div class="rightD">
            <div v-if="isLook" style="width:100%;height:100%;position:absolute;left:0;top:40px;z-index:10;opacity:1;"></div>
              ...
              <el-tab-pane label="组件"  name="first" v-if="musicPower.length">
                <p class="font20">主节点</p>
                <el-button type="primary" style="width:100px;" @click="addNode({step:1,text:'音乐',type:'music',data:nodeData1,isLastNode:false,icon:''})" :disabled="!musicPower[0].isCheck||isLook">音乐</el-button>
                <p class="font20">素材节点</p>
                <el-button type="primary" style="width:100px;"  @click="addNode({step:2,text:'MP3',type:'mp3',data:nodeData2,isLastNode:true,icon:'music'})" :disabled="!musicPower[0].isCheck||isLook">MP3</el-button>
                <el-button type="primary" style="width:100px;" @click="addNode({step:2,text:'OGG',type:'ogg',data:nodeData2,isLastNode:true,icon:'music'})" :disabled="!musicPower[0].isCheck||isLook">OGG</el-button>
                <el-button type="primary" style="width:100px;"  @click="addNode({step:2,text:'WAV',type:'wav',data:nodeData2,isLastNode:true,icon:'music'})" :disabled="!musicPower[0].isCheck||isLook">WAV</el-button>
              </el-tab-pane>
