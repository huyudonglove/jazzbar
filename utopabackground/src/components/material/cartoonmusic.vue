    ...
    <div>
      <div class="layoutD">
        <div class="leftD" id="myMinder">
          ...
          <el-button type="primary" style="position:absolute;right:10px;top:10px;" @click="add" v-if="animationMusicPower.length" :disabled="isLook">确定</el-button>
        </div>
        <div class="rightD">
          <el-tabs type="border-card" v-model="activeName">
            <el-tab-pane label="组件"  name="first" v-if="animationMusicPower.length">
              <p class="font20">主节点</p>
              <el-button type="primary" @click="nodeMsg.text='动画音乐';nodeMsg.type='动画音乐',nodeMsg.data=nodeData1;nodeMsg.isLastNode=false;nodeMsg.icon='gif';addNode(nodeMsg)" style="width:100px;" :disabled="isLook||!animationMusicPower[0].isCheck">动画音乐</el-button>
              <p class="font20">素材节点</p>
                <p>
                  <el-button type="primary" @click="addNode({step:2,text:'Android',type:'android',data:nodeData2,isLastNode:true})" style="width:100px;" :disabled="isLook||!animationMusicPower[0].isCheck">Android</el-button>
                  <el-button type="primary" @click="addNode({step:2,text:'IOS',type:'ios',data:nodeData2,isLastNode:true})" style="width:100px;" :disabled="isLook||!animationMusicPower[0].isCheck">IOS</el-button>
                </p>
                <p>
                  <el-button type="primary" @click="addNode({step:2,text:'UWP',type:'uwp',data:nodeData2,isLastNode:true})" style="width:100px;" :disabled="isLook||!animationMusicPower[0].isCheck">UWP</el-button>
                  <el-button type="primary" @click="addNode({step:2,text:'Windows',type:'windows',data:nodeData2,isLastNode:true})" style="width:100px;" :disabled="isLook||!animationMusicPower[0].isCheck">Windows</el-button>
                </p>
            </el-tab-pane>
            <el-tab-pane label="属性" :disabled="!isPermitClick"   name="second">
              ...
              <el-form ref="form" :model="nodeData" label-width="80px">
                ...
                <el-form-item label="音乐文件" v-if="nodeData.fileId!==undefined" required>
                  <upLoadM @getFileData="getVideo" :name="nodeData.fileName" type="mp3/mid/MP3/MID"></upLoadM>
                </el-form-item>
...
<script>
  ...
  export default {
    ...
    computed:{
      ...
      nodeColor1(){
        return this.nodeData.name&&this.nodeData.materialCategoryId&&this.nodeData.fileId
      },
