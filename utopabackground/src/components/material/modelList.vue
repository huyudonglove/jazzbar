    ...
    <div v-if="type=='list'">
      <div style="background:#f0f0f5;margin-top:10px">
        <el-row class="tac" style="border-bottom:1px solid #eeeeee; padding:15px 0">
          ...
          <span class="myWords">
                       <cascader  :routeParams="true" :moduleId='`103`' ref="filter" style="display: inline-block"></cascader>
            </span>
          <span class="myWords">
          ...
          <span>
            <commonDel :id='selectId'  :all="true" style="display: inline-block" :disabled="!modelPower[3].isCheck" v-if="modelPower.length"></commonDel>
          </span>
        </el-row>
      </div>
      <div>
        <el-table :data="tableData" stripe style="width: 100%" @selection-change="handleSelectionChange" border  ref="listTable" row-key="id" :max-height="tableHeight" :cell-class-name="offLine">
          ...
          <el-table-column prop="address" label="操作(请只操作魔幻演奏)" width="280">
            <template slot-scope="scope" v-if="modelPower.length">
              <el-button size="mini" @click="buttonClick('edit',scope.row)" type="primary" :disabled="!modelPower[1].isCheck">编辑</el-button>
              <el-button size="mini" @click="buttonClick('watch',scope.row)" type="warning" :disabled="!modelPower[2].isCheck">查看</el-button>
              <commonDel :id='[scope.row.id]' style="display: inline-block" :disabled="!modelPower[3].isCheck"></commonDel>
            </template>
          </el-table-column>
        </el-table>
      </div>
        ...
        <el-row class="tac" style="border-bottom:1px solid #eeeeee; padding:15px 0">
          ...
          <div>
            ...
            <!-- <span>
              ...
              <span class="myWords">
                  <cascader  @changeVal="change" :routeParams="false" :moduleId='`103`' ref="filter" style="display: inline-block"></cascader>
            </span>
          </div>
        </el-row>
