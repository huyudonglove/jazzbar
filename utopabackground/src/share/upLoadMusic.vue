  ...
  methods:{
    ...
    uploadSuccess(res){
      ...
      if(res.code){
        ...
        this.$emit('getFileData',{"fileId":res.data.fileId,"name":res.data.originFileName,"size":res.data.size,"duration":this.duration,materialFormat:res.data.materialFormat});
      }
    },
    uploadError(err){
      this.fileList=[];
