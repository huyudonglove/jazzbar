...
// })(this,function(){
  ...
  XUMinder.prototype = {
    ...
    renderLine:function(x1,y1,x2,y2,startRectName,endRectName){
    ...
    dragstart:function(e){
      ...
      let currentPositionArr=this.currentClick.getAttribute('transform')?this.currentClick.getAttribute('transform').slice(10,-1).split(","):[0,0];
    ...
    dragmove:function(e){
      let matrix = this.g_big.getAttribute('transform').slice(7,-1).split(",")[0];//缩放
    ...
    drawLineStart:function(e){//
      ...
      this.lineStartX = Number(this.drawStart.circleRight.getAttribute('cx'))+gXStart;
    ...
    drawLineEnd:function(e){
      ...
      this.lineEndX = Number(drawEnd.circleLeft.getAttribute('cx'))+gXEnd;
    ...
    delLine:function(e){
      ...
      let startRectName = e.target.getAttribute('start');
      let endRectName = e.target.getAttribute('end');
      ...
      this.g_line.removeChild(e.target);
      console.log(this.treeData,'this.treeData');
    },
    copy:function(){
      console.log('copy')
    ...
    remove:function(type,callback){//监听
      if(this.topicMenu){
